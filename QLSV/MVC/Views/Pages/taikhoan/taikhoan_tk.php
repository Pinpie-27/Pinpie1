...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/QLSV/Public/Css/taikhoan_tk.css">
</head>
<body>
    <div class="main">
        <header class="header">
        ...
        <div class="container">
            <div class="container__header">
                <div class="search">
                    <form class="form_search" action="http://localhost/QLSV/dangnhap/find" method="POST">
                        <label for="" class="search__label">Tìm kiếm</label>
                        <input type="text" name="txtSearch" placeholder="Nhập tên người dùng" value="<?php if(isset($data['username'])) echo $data['username'] ?>" id="txtSearch" class="search__input">
                        <input class="btnSearch" name="btnSearch" type="submit" value="Tìm kiếm">
                    </form>
                </div>
            </div>
            <div class="container__content">
                <table class="taikhoan_tk">
                    <tr>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align: left" class="col-1-4">
                                <a href="http://localhost/QLSV/account/delete/<?php echo $row['username'] ?>">
                                    <lord-icon
